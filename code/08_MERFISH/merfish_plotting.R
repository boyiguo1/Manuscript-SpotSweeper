...
plot_dir <- here("plots","MERFISH")

spe <-  readRDS(here("processed-data",  "MERFISH",  "merfish_spotsweeper_banksy.rds"))
spe
...
png(here(plot_dir, "MERFISH_outliers_per_domain.png"), width=15, height=5, res=300, units="in")
...
# ============ Plotting here =============
png(here(plot_dir, "MERFISH_Banksy_domains.png"), width=4, height=5, units="in", res=300)
make_escheR(spe) |>
...
png(here(plot_dir, "MERFISH_nCounts_3MAD.png"), width=5, height=5, res=300, units="in")
...
png(here(plot_dir, "MERFISH_nCounts_threshold.png"), width=5, height=5, res=300, units="in")
...
png(here(plot_dir, "MERFISH_nCounts_spotsweeper.png"), width=5, height=5, res=300, units="in")
...
png(here(plot_dir, "MERFISH_ridge_nCounts_umi.png"), width=4, height=6, res=300, units="in")
...
png(here(plot_dir, "MERFISH_ridge_unique_genes.png"), width=4, height=6, res=300, units="in")
...
# ridge plot of nCounts_umi with a threshold of 500
png(here(plot_dir, "MERFISH_ridge_nCounts_umi_spotsweeper.png"), width=4, height=6, res=300, units="in")
...
png(here(plot_dir, "MERFISH_ridge_unique_genes_spotsweeper.png"), width=4, height=6, res=300, units="in")
...
p5 <- plotReducedDim(spe, "UMAP", colour_by = "nCounts", point_size=0.2) +
  labs(title = "Library Size") +
  theme(plot.title = element_text(size = 20))

p6 <- plotReducedDim(spe, "UMAP", colour_by = "nGenes", point_size=0.2) +
  labs(title = "Unique Genes") +
  theme(plot.title = element_text(size = 20))

png(here(plot_dir, 'MERFISH_UMAP.png'), width=15, height=10, units="in", res=300)
(p1+p2+p3)/(p4+p5+p6)
dev.off()
