...
spe <- readRDS(here("processed-data",  "Xenium", "MouseBrain_5k", "Xenium_MouseBrain_spotsweeper.rds"))
spe
...
saveRDS(spe, here("processed-data",  "Xenium", "MouseBrain_5k", "Xenium_MouseBrain_spotsweeper_banksy.rds"))
