...
plot_dir <- here("plots","VisiumHD","mouse_brain","016")
...
png(here(plot_dir, "HD_MouseBrain_016_outliers_per_domain.png"), width=4, height=12, res=300, units="in")
...
# ============ Plotting here =============
png(here(plot_dir, "HD_MouseBrain_016_Banksy_domains.png"), width=5, height=5, units="in", res=300)
make_escheR(spe) |>
...
png(here(plot_dir, "HD_MouseBrain_016_sum_3MAD.png"), width=5, height=5, res=300, units="in")
...
png(here(plot_dir, "HD_MouseBrain_016_sum_threshold.png"), width=5, height=5, res=300, units="in")
...
png(here(plot_dir, "HD_MouseBrain_016_sum_spotsweeper.png"), width=5, height=5, res=300, units="in")
...
png(here(plot_dir, "HD_MouseBrain_016_ridge_sum_umi.png"), width=4, height=6, res=300, units="in")
...
png(here(plot_dir, "HD_MouseBrain_016_ridge_mito_percent.png"), width=4, height=6, res=300, units="in")
...
png(here(plot_dir, "HD_MouseBrain_016_ridge_unique_genes.png"), width=4, height=6, res=300, units="in")
...
# ridge plot of sum_umi with a threshold of 500
png(here(plot_dir, "HD_MouseBrain_016_ridge_sum_umi_spotsweeper.png"), width=4, height=6, res=300, units="in")
...
png(here(plot_dir, "HD_MouseBrain_016_ridge_mito_percent_spotsweeper.png"), width=4, height=6, res=300, units="in")
...
png(here(plot_dir, "HD_MouseBrain_016_ridge_unique_genes_spotsweeper.png"), width=4, height=6, res=300, units="in")
...
png(here(plot_dir, 'HD_MouseBrain_016_umap.png'), width=15, height=10, units="in", res=300)
(p1+p2+p3)/(p4+p5+p6)
dev.off()
