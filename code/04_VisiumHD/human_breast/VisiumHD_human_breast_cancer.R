...
hd_dir <-  here("raw-data", "VisiumHD", "Visium_HD_Human_Breast", "output", "binned_outputs")
...
# save
saveRDS(spe.008, file=here("processed-data", "VisiumHD", "VisiumHD_HumanBreast_008.rds"))
saveRDS(spe.016, file=here("processed-data", "VisiumHD", "VisiumHD_HumanBreast_016.rds"))
saveRDS(spe.002, file=here("processed-data", "VisiumHD", "VisiumHD_HumanBreast_002.rds"))
