...
spe <- readRDS(here("processed-data", "Slideseq","SlideseqCerebellum","slideseq_cerebellum_spotsweeper.rds"))
spe
...
outlier_df <- data.frame(MAD=spe$MAD_outliers,
                         ...
                         domain=factor(spe$clust_M0_lam0.3_k50_res0.7),
                         sum = spe$sum,
...
png(here(plot_dir, "cerebellum_outliers_per_domain.png"), width=4.5, height=5, res=300, units="in")
ggplot(outlier_df, aes(x=domain, y=count, fill=method)) +
    geom_bar(stat="identity", position="dodge") +
    labs(x="Spatial Domain", y="Number of Outliers", fill="Method") +
    theme_classic() +
    scale_fill_manual(values=c("#eb7c69","#fda638", "#b82ac9"),
...
png(here(plot_dir, "cerebellum_ridge_sum_umi.png"), width=4, height=4, res=300, units="in")
...
# png(here(plot_dir, "cerebellum_ridge_mito_percent.png"), width=4, height=4, res=300, units="in")
...
png(here(plot_dir, "cerebellum_ridge_unique_genes.png"), width=4, height=4, res=300, units="in")
...
# ridge plot of sum_umi with a threshold of 500
png(here(plot_dir, "cerebellum_ridge_sum_umi_spotsweeper.png"), width=4, height=4, res=300, units="in")
...
# png(here(plot_dir, "cerebellum_ridge_mito_percent_spotsweeper.png"), width=4, height=4, res=300, units="in")
...
png(here(plot_dir, "cerebellum_ridge_unique_genes_spotsweeper.png"), width=4, height=4, res=300, units="in")
