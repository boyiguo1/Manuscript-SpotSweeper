...
spe <- readRDS(here("processed-data", "Slideseq","SlideseqV2Hippocampus","slideseq_hippocampus_spotsweeper.rds"))
spe
...
pdf(here(plot_dir, "hippocampus_outliers_per_domain.pdf"), width=4.5, height=6)
...
write.csv(outlier_df, 
          file = here("processed-data", "outputs_for_paper", "figure_4", "Figure4_R.csv"),
...
# to csv
write.csv(outlier_df, 
          file = here("processed-data", "outputs_for_paper", "figure_4", "Figure4_HM.csv"),
          row.names = FALSE, quote = FALSE)
...
pdf(here(plot_dir, "hippocampus_ridge_sum_umi.pdf"), width=4, height=6)
...
pdf(here(plot_dir, "hippocampus_ridge_mito_percent.pdf"), width=4, height=6)
...
pdf(here(plot_dir, "hippocampus_ridge_unique_genes.pdf"), width=4, height=6)
...
# ridge plot of sum_umi with a threshold of 500
pdf(here(plot_dir, "hippocampus_ridge_sum_umi_spotsweeper.pdf"), width=4, height=6)
...
pdf(here(plot_dir, "hippocampus_ridge_mito_percent_spotsweeper.pdf"), width=4, height=6)
...
pdf(here(plot_dir, "hippocampus_ridge_unique_genes_spotsweeper.pdf"), width=4, height=6)
