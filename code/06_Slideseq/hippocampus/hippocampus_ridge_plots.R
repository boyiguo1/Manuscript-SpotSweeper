...
png(here(plot_dir, "hippocampus_outliers_per_domain.png"), width=4.5, height=6, res=300, units="in")
...
png(here(plot_dir, "hippocampus_ridge_sum_umi.png"), width=4, height=6, res=300, units="in")
...
png(here(plot_dir, "hippocampus_ridge_mito_percent.png"), width=4, height=6, res=300, units="in")
...
png(here(plot_dir, "hippocampus_ridge_unique_genes.png"), width=4, height=6, res=300, units="in")
...
# ridge plot of sum_umi with a threshold of 500
png(here(plot_dir, "hippocampus_ridge_sum_umi_spotsweeper.png"), width=4, height=6, res=300, units="in")
...
png(here(plot_dir, "hippocampus_ridge_mito_percent_spotsweeper.png"), width=4, height=6, res=300, units="in")
...
png(here(plot_dir, "hippocampus_ridge_unique_genes_spotsweeper.png"), width=4, height=6, res=300, units="in")
